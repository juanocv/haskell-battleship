...
/* package battleshyp-0.1.0.0 */
#ifndef VERSION_battleshyp
#define VERSION_battleshyp "0.1.0.0"
#endif /* VERSION_battleshyp */
#ifndef MIN_VERSION_battleshyp
#define MIN_VERSION_battleshyp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_battleshyp */
...
#define CURRENT_COMPONENT_ID "battleshyp-0.1.0.0-9ZFdXYhIwrPEtewRyXdiNr-battleshyp"
